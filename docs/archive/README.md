...
This directory contains older research documents and reference material that informed the current architecture. They are preserved for historical context and may contain analysis that is still partially relevant, but they predate the current node library and should not be treated as authoritative.
